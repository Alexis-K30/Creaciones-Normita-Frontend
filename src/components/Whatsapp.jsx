...
const Whatsapp = () => {
    return (
        <div className="fixed bottom-6 right-6 z-50 group">
            <a href="https://wa.me/50376831744?text=Hola,%20me%20interesa%20tu%20servicio" 
               target="_blank"
               rel="noopener noreferrer"
               className="flex items-center justify-center w-14 h-14 bg-green-500 rounded-full shadow-lg 
                      hover:bg-green-600 transform hover:scale-110 transition text-white relative 
                ...
                {/* Tooltip */}
                <span className="absolute bottom-16 right-0 bg-black text-white text-xs px-2 py-1 rounded-md 

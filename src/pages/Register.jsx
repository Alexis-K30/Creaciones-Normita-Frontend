      ...
      <div className="max-w-2xl w-full space-y-8 bg-white p-10 rounded-3xl shadow-2xl shadow-pink-100 border border-pink-50 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="mt-2 text-slate-500 font-medium">
            Únete a nuestra comunidad de elegancia
          </p>
        </div>

        <form
          className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10"
          onSubmit={handleSubmit}
        >
          {error && (
            <div className="col-span-full bg-red-50 text-red-500 p-4 rounded-xl text-sm font-bold border border-red-100">
              {error}
            </div>
          )}

          {success && (
            <div className="col-span-full bg-green-50 text-green-600 p-4 rounded-xl text-sm font-bold border border-green-100">
            ...
            <>
              ...
              <div className="col-span-full pt-4">
                ...
                <p className="mt-6 text-center text-sm font-medium text-slate-500">
                  ...
                  <Link
                    to="/login"
                    className="font-black text-pink-600 hover:text-pink-700 transition"
                  >
                    Inicia Sesión
                  </Link>
                </p>
          ...
          {success && (
            <div className="col-span-full pt-4">
              <button
                ...
                className="group relative w-full flex justify-center py-4 px-4 border border-transparent text-sm font-black uppercase tracking-widest rounded-2xl text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all shadow-xl shadow-green-200"
              >
                Ir al Login
              </button>
            </div>
